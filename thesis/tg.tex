...
\bookmark[level=0, page=4]{Folha de Aprova\ca o}
...
\input{citacao}
\thispagestyle{empty}
\bookmark[level=0, page=7]{Cita\ca o}
...
\chapter{Algoritmo Evolutivo}
\input{algoritmo_genetico}
...
%Fim do trabalho antigo

% TODO: descobrir por que este .tex está dando problemas aqui
