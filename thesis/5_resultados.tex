...
\begin{figure}[ht!]
    ...
    \caption{Evolução do fitness para o problema do OneMax Real Adaptativo mostrando mínimo, máximo e valor médio ($p_c=0.9$, $p_{m0}=0.01$).}
...
\begin{figure}[ht!]
    ...
    \caption{Desvio padrão ao longo das gerações para o problema do Caixeiro Viajante Adaptado ($p_c=0.9$, $p_{m0}=0.01$).}
    \label{fig:tsp001std}
\end{figure}
...
\begin{figure}[ht!]
    ...
    \caption{Desvio padrão ao longo das gerações para o problema do Caixeiro Viajante Adaptado ($p_c=0.9$, $p_{m0}=0.2$).}
    \label{fig:tsp02std}
\end{figure}
